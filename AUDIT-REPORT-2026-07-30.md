...
| Rate limiting | 2× | ❌ | 39/74 fns use `checkRateLimit`. Crons don't need it, but not every user-callable fn is covered — no inventory exists of which user-facing fns lack it. |
