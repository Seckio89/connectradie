            ...
            <div className="space-y-10">
              ...
              <section>
                ...
                <div className="space-y-5">
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">2.1 Credential Warranty</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">2.2 Insurance Requirement</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">2.3 Verification Limitation</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                ...
                <div className="space-y-5">
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">3.1 Secure Payment Model</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">3.2 Secure Processing</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">3.3 Non-Circumvention</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">3.4 Profile Visibility & Anti-Circumvention</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">3.5 Service Fees & GST</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                ...
                <div className="space-y-5">
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">4.1 ACL Safe-Harbour</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">4.2 Exclusion of Liability</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">4.3 Aggregate Liability Cap</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">4.4 Indemnity</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                ...
                <div className="space-y-5">
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">5.1 Prohibited Conduct</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">Users must not:</p>
                    <ul className="mt-3 space-y-2">
                      <li className="flex items-start gap-3 text-[15px] text-ct-mute-2">
                        <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">5.2 Suspension & Termination</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">5.3 Right of Appeal</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                ...
                <div className="space-y-5">
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">6.1 Ownership</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">6.2 User Content Licence</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-ct-paper mb-1.5">6.3 Your Warranties</h3>
                    <p className="text-[15px] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-[15px] font-semibold text-ct-paper mb-1">Direct Negotiation</h3>
                      <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-[15px] font-semibold text-ct-paper mb-1">Internal Mediation</h3>
                      <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-[15px] font-semibold text-ct-paper mb-1">External Resolution</h3>
                      <p className="text-[15px] text-ct-mute-2 leading-relaxed">
                ...
                <div className="mt-5 bg-ct-surface-2 rounded-ct-md p-4 border border-ct-line-soft">
                  <h3 className="text-[15px] font-semibold text-ct-paper mb-1">Governing Law</h3>
                  <p className="text-sm text-ct-mute-2 leading-relaxed">
              ...
              <section>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[15px] text-ct-mute-2"><strong className="text-ct-paper">Severability:</strong> Invalid provisions will be severed with minimum effect on the remainder.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[15px] text-ct-mute-2"><strong className="text-ct-paper">Entire Agreement:</strong> These Terms, Privacy Policy, and supplementary policies constitute the entire agreement.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[15px] text-ct-mute-2"><strong className="text-ct-paper">Waiver:</strong> Failure to enforce a right is not a waiver of that right.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[15px] text-ct-mute-2"><strong className="text-ct-paper">No Assignment by Users:</strong> You may not assign rights without ConnecTradie&rsquo;s written consent.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[15px] text-ct-mute-2"><strong className="text-ct-paper">ConnecTradie Assignment:</strong> ConnecTradie may assign rights in connection with a merger, acquisition, or asset sale, with 30 days written notice.</p>
                  </div>
                </div>
              </section>
            </div>
