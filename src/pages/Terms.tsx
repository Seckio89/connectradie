...
export default function Terms() {
  return (
    <div className="min-h-screen bg-ct-surface-2">
      ...
      {/* Header */}
      <header className="sticky top-0 z-30 bg-ct-surface/95 backdrop-blur-sm border-b border-ct-line shadow-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link
              to="/"
              className="inline-flex items-center gap-2 text-sm font-medium text-ct-mute hover:text-ct-paper transition-colors"
            >
      ...
      {/* Hero / Title Area */}
      <div className="bg-ct-surface border-b border-ct-line">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          <div className="flex items-start gap-4">
            <div className="hidden sm:flex w-12 h-12 bg-ct-surface-2 rounded-ct-md items-center justify-center flex-shrink-0">
              <Scale className="w-6 h-6 text-ct-mute-2" />
            </div>
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-ct-paper tracking-tight">Terms of Service & User Agreement</h1>
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-2">
                ...
                <span className="text-xs text-ct-mute">Effective: 7 March 2026</span>
                <span className="text-xs text-ct-mute">ABN: 75 655 516 546</span>
                <span className="text-xs text-ct-mute">Governing Law: New South Wales</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main id="main-content" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        <div className="bg-ct-surface rounded-ct-lg border border-ct-line shadow-sm overflow-hidden">
          <div className="px-6 sm:px-10 py-8 sm:py-10">
            ...
            {/* Preamble */}
            <div className="mb-10 pb-10 border-b border-ct-line-soft">
              <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                ...
                <Link to="/privacy" className="text-ct-mute-2 hover:text-ct-mute-2 font-medium underline decoration-primary-300 underline-offset-2">Privacy Policy</Link>, which is incorporated by reference. If you do not agree, you must not use the Platform.
              </p>
              <div className="mt-5 flex items-start gap-3 bg-ct-surface-2/70 border border-ct-line rounded-ct-md p-4">
            ...
            <div className="space-y-10">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-3 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">1.</span> Nature of Our Service & Relationship
                </h2>
                <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
              ...
              <hr className="border-ct-line-soft" />

              {/* Section 2 */}
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">2.</span> Tradie Warranties & Verification
                </h2>

                <div className="space-y-5">
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">2.1 Credential Warranty</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">2.2 Insurance Requirement</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">2.3 Verification Limitation</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">3.</span> Payments, Fees, Platform Integrity & Payment Security
                </h2>

                <div className="space-y-5">
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">3.1 Secure Payment Model</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">3.2 Secure Processing</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">3.3 Non-Circumvention</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                    ...
                    <div className="mt-3 bg-ct-amber/[0.13] border-l-4 border-ct-amber/[0.34] pl-4 py-3 pr-4 rounded-r-lg">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">3.4 Profile Visibility & Anti-Circumvention</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">3.5 Service Fees & GST</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">4.</span> Limitation of Liability & Indemnity
                </h2>

                <div className="space-y-5">
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">4.1 ACL Safe-Harbour</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">4.2 Exclusion of Liability</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">4.3 Aggregate Liability Cap</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">4.4 Indemnity</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">5.</span> User Conduct & Account Termination
                </h2>

                <div className="space-y-5">
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">5.1 Prohibited Conduct</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">Users must not:</p>
                    <ul className="mt-3 space-y-2">
                      <li className="flex items-start gap-3 text-[0.9375rem] text-ct-mute-2">
                        <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">5.2 Suspension & Termination</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">5.3 Right of Appeal</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">6.</span> Intellectual Property & User Content
                </h2>

                <div className="space-y-5">
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">6.1 Ownership</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">6.2 User Content Licence</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1.5">6.3 Your Warranties</h3>
                    <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-3 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">7.</span> Privacy
                </h2>
                <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <Link to="/privacy" className="text-ct-mute-2 hover:text-ct-mute-2 font-medium underline decoration-primary-300 underline-offset-2">Privacy Policy</Link>{' '}
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-3 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">8.</span> Force Majeure
                </h2>
                <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-3 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">9.</span> Amendments to These Terms
                </h2>
                <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">10.</span> Dispute Resolution
                </h2>

                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <span className="flex-shrink-0 w-7 h-7 bg-ct-surface-2 text-ct-mute-2 rounded-full flex items-center justify-center text-xs font-bold mt-0.5">1</span>
                    <div>
                      <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1">Direct Negotiation</h3>
                      <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div className="flex items-start gap-4">
                    <span className="flex-shrink-0 w-7 h-7 bg-ct-surface-2 text-ct-mute-2 rounded-full flex items-center justify-center text-xs font-bold mt-0.5">2</span>
                    <div>
                      <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1">Internal Mediation</h3>
                      <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                  ...
                  <div className="flex items-start gap-4">
                    <span className="flex-shrink-0 w-7 h-7 bg-ct-surface-2 text-ct-mute-2 rounded-full flex items-center justify-center text-xs font-bold mt-0.5">3</span>
                    <div>
                      <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1">External Resolution</h3>
                      <p className="text-[0.9375rem] text-ct-mute-2 leading-relaxed">
                ...
                <div className="mt-5 bg-ct-surface-2 rounded-ct-md p-4 border border-ct-line-soft">
                  <h3 className="text-[0.9375rem] font-semibold text-ct-paper mb-1">Governing Law</h3>
                  <p className="text-sm text-ct-mute-2 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">11.</span> General Provisions
                </h2>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[0.9375rem] text-ct-mute-2"><strong className="text-ct-paper">Severability:</strong> Invalid provisions will be severed with minimum effect on the remainder.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[0.9375rem] text-ct-mute-2"><strong className="text-ct-paper">Entire Agreement:</strong> These Terms, Privacy Policy, and supplementary policies constitute the entire agreement.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[0.9375rem] text-ct-mute-2"><strong className="text-ct-paper">Waiver:</strong> Failure to enforce a right is not a waiver of that right.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[0.9375rem] text-ct-mute-2"><strong className="text-ct-paper">No Assignment by Users:</strong> You may not assign rights without ConnecTradie&rsquo;s written consent.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-ct-surface-2 rounded-full flex-shrink-0 mt-2" />
                    <p className="text-[0.9375rem] text-ct-mute-2"><strong className="text-ct-paper">ConnecTradie Assignment:</strong> ConnecTradie may assign rights in connection with a merger, acquisition, or asset sale, with 30 days written notice.</p>
                  </div>
                </div>
              </section>
            </div>
            ...
            <div className="mt-10 pt-8 border-t border-ct-line">
              <h2 className="text-lg font-bold text-ct-paper mb-3">Contact</h2>
              <div className="bg-ct-surface-2 rounded-ct-md p-6 border border-ct-line-soft">
                <p className="font-semibold text-ct-paper">ConnecTradie Pty Ltd</p>
                <p className="text-ct-mute-2 mt-1.5">
                  <a href="mailto:admin@connectradie.com" className="inline-flex items-center min-h-[44px] text-ct-mute-2 hover:text-ct-mute-2 font-medium underline decoration-primary-300 underline-offset-2">admin@connectradie.com</a>
                </p>
                <p className="text-sm text-ct-mute mt-1">ABN: 75 655 516 546</p>
              </div>
            </div>
        ...
        {/* Footer note */}
        <p className="text-center text-xs text-ct-mute mt-6 mb-4">
