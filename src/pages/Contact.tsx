            ...
            {submitted ? (
              <div className="bg-ct-surface rounded-ct-lg border border-ct-line p-8 text-center">
                ...
                <button
                  ...
                  className="text-ct-mute-2 font-medium hover:text-ct-mute-2 transition-colors"
                >
                  Send another message
                </button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="bg-ct-surface rounded-ct-lg border border-ct-line p-6 sm:p-8 space-y-5">
                {error && (
                ...
                <div>
                  <label htmlFor="contact-name" className="block text-sm font-medium text-ct-mute-2 mb-2">Name</label>
                  <input
                    id="contact-name"
                    type="text"
                    required
                ...
                <div>
                  <label htmlFor="contact-email" className="block text-sm font-medium text-ct-mute-2 mb-2">Email</label>
                  <input
                    id="contact-email"
                    type="email"
                    required
                ...
                <div>
                  <label htmlFor="contact-message" className="block text-sm font-medium text-ct-mute-2 mb-2">Message</label>
                  <textarea {...proseInputProps}
                    ...
                    className="w-full px-4 py-3 border border-ct-line rounded-ct-md focus:outline-none focus:ring-2 focus:ring-ct-teal focus:border-ct-teal transition-all resize-none"
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="w-full py-3 px-4 bg-ct-teal text-ct-ink font-semibold rounded-ct-md hover:brightness-110 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
                >
                  {sending ? (
                    <>
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-ct-surface rounded-ct-lg border border-ct-line p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 text-ct-mute-2">
                  <MapPin className="w-5 h-5 text-ct-mute" />
