        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          <div className="flex items-start gap-4">
            <div className="hidden sm:flex w-12 h-12 bg-ct-surface-2 rounded-ct-md items-center justify-center flex-shrink-0">
              <Lock className="w-6 h-6 text-ct-mute-2" />
            </div>
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-ct-paper tracking-tight">Privacy Policy</h1>
        ...
        <div className="bg-ct-surface rounded-ct-lg border border-ct-line shadow-sm overflow-hidden">
          <div className="px-6 sm:px-10 py-8 sm:py-10">
            ...
            <div className="mb-10 pb-10 border-b border-ct-line-soft">
              <div className="flex items-start gap-3 bg-ct-surface-2/70 border border-ct-line rounded-ct-md p-4 mb-5">
            ...
            <div className="space-y-10">
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">2.</span> Information We Collect & Why
                </h2>
                  ...
                  <div>
                    ...
                    <div className="overflow-x-auto rounded-ct-sm border border-ct-line">
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="bg-ct-surface-2">
                            <th className="text-left px-4 py-2.5 font-semibold text-ct-mute-2 text-xs uppercase tracking-wide">Provider</th>
                            <th className="text-left px-4 py-2.5 font-semibold text-ct-mute-2 text-xs uppercase tracking-wide">Purpose</th>
                            <th className="text-left px-4 py-2.5 font-semibold text-ct-mute-2 text-xs uppercase tracking-wide">Data Location</th>
                          </tr>
                        </thead>
                        <tbody className="text-ct-mute-2">
                          <tr className="border-t border-ct-line-soft">
                            <td className="px-4 py-2.5 font-medium text-ct-paper">Stripe</td>
                          ...
                          <tr className="border-t border-ct-line-soft bg-ct-surface-2">
                            <td className="px-4 py-2.5 font-medium text-ct-paper">Supabase</td>
                            <td className="px-4 py-2.5">Database & backend infrastructure</td>
                            <td className="px-4 py-2.5">United States (AWS)</td>
                          </tr>
                          <tr className="border-t border-ct-line-soft">
                            <td className="px-4 py-2.5 font-medium text-ct-paper">Google LLC</td>
                          ...
                          <tr className="border-t border-ct-line-soft bg-ct-surface-2">
                            <td className="px-4 py-2.5 font-medium text-ct-paper">ABN Lookup (ATO)</td>
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">5.</span> Security: Protecting Your Data
                </h2>
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-4 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">6.</span> Your Rights Under Australian Law
                </h2>

                <div className="overflow-x-auto rounded-ct-sm border border-ct-line mb-4">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-ct-surface-2">
                        <th className="text-left px-4 py-2.5 font-semibold text-ct-mute-2 text-xs uppercase tracking-wide w-36">Right</th>
                        <th className="text-left px-4 py-2.5 font-semibold text-ct-mute-2 text-xs uppercase tracking-wide">What This Means</th>
                      </tr>
                    </thead>
                    <tbody className="text-ct-mute-2">
                      <tr className="border-t border-ct-line-soft">
                        <td className="px-4 py-3 font-medium text-ct-paper align-top">Access</td>
                        <td className="px-4 py-3">Request the personal information we hold about you. We respond within 30 days.</td>
                      </tr>
                      <tr className="border-t border-ct-line-soft bg-ct-surface-2">
                        <td className="px-4 py-3 font-medium text-ct-paper align-top">Correction</td>
                        <td className="px-4 py-3">Request correction of inaccurate or incomplete information. We respond within 30 days.</td>
                      </tr>
                      <tr className="border-t border-ct-line-soft">
                        <td className="px-4 py-3 font-medium text-ct-paper align-top">Deletion</td>
                      ...
                      <tr className="border-t border-ct-line-soft bg-ct-surface-2">
                        <td className="px-4 py-3 font-medium text-ct-paper align-top">Data Portability</td>
                        <td className="px-4 py-3">Request an export of your personal data in CSV or JSON format. We respond within 30 days.</td>
                      </tr>
                      <tr className="border-t border-ct-line-soft">
                        <td className="px-4 py-3 font-medium text-ct-paper align-top">Consent Withdrawal</td>
                      ...
                      <tr className="border-t border-ct-line-soft bg-ct-surface-2">
                        <td className="px-4 py-3 font-medium text-ct-paper align-top">Complaint</td>
              ...
              <section>
                ...
                <div className="overflow-x-auto rounded-ct-sm border border-ct-line mb-4">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-ct-surface-2">
                        <th className="text-left px-4 py-2.5 font-semibold text-ct-mute-2 text-xs uppercase tracking-wide">Data Category</th>
                        <th className="text-left px-4 py-2.5 font-semibold text-ct-mute-2 text-xs uppercase tracking-wide">Retention Period</th>
                        <th className="text-left px-4 py-2.5 font-semibold text-ct-mute-2 text-xs uppercase tracking-wide">Legal Basis</th>
                      </tr>
                    </thead>
                    <tbody className="text-ct-mute-2">
                      <tr className="border-t border-ct-line-soft">
                        <td className="px-4 py-2.5 font-medium text-ct-paper">Account data</td>
                        <td className="px-4 py-2.5">Duration + 7 years</td>
                        <td className="px-4 py-2.5">ATO requirements</td>
                      </tr>
                      <tr className="border-t border-ct-line-soft bg-ct-surface-2">
                        <td className="px-4 py-2.5 font-medium text-ct-paper">Transaction & financial records</td>
                      ...
                      <tr className="border-t border-ct-line-soft">
                        <td className="px-4 py-2.5 font-medium text-ct-paper">Marketing consent records</td>
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-3 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">8.</span> Cookies & Tracking Technologies
                </h2>
              ...
              <section>
                <h2 className="text-lg font-bold text-ct-paper mb-3 flex items-baseline gap-2">
                  <span className="text-ct-mute-2">10.</span> Contact Our Privacy Officer
                </h2>

                <div className="bg-ct-surface-2 rounded-ct-md p-6 border border-ct-line-soft">
                  <div className="space-y-2.5">
                    <div className="flex items-start gap-3">
                      <span className="text-sm text-ct-mute w-36 flex-shrink-0 font-medium">Privacy Officer</span>
                      <span className="text-sm text-ct-paper">The Directors, ConnecTradie Pty Ltd</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-sm text-ct-mute w-36 flex-shrink-0 font-medium">Email</span>
                      <a href="mailto:admin@connectradie.com" className="text-sm text-ct-mute-2 hover:text-ct-mute-2 font-medium underline decoration-primary-300 underline-offset-2">admin@connectradie.com</a>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-sm text-ct-mute w-36 flex-shrink-0 font-medium">Address</span>
                      <span className="text-sm text-ct-paper">ConnecTradie Pty Ltd, Sydney NSW, Australia</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-sm text-ct-mute w-36 flex-shrink-0 font-medium">ABN</span>
                      <span className="text-sm text-ct-paper">75 655 516 546</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-sm text-ct-mute w-36 flex-shrink-0 font-medium">Response Timeframe</span>
                      <span className="text-sm text-ct-paper">Within 30 days of receiving your request</span>
                    </div>
                  </div>
                </div>
