...
function Faq({ q, children }: { q: string; children: React.ReactNode }) {
  return (
    <div className="py-5 border-b border-ct-line last:border-0">
      <h3 className="text-sm font-semibold text-ct-paper mb-1.5">{q}</h3>
      <div className="text-sm text-ct-mute-2 leading-relaxed space-y-2">{children}</div>
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-ct-surface-2">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        <div>
          <h1 className="text-2xl font-bold text-ct-paper mb-2">How fees work</h1>
        ...
        <section className="bg-ct-surface rounded-ct-md shadow-sm p-6">
          <h2 className="text-lg font-semibold text-ct-paper mb-3">Following one job through</h2>
          <p className="text-sm text-ct-mute-2 leading-relaxed mb-5">
            Sarah needs her hot water system replaced. Dave the plumber quotes{' '}
            <span className="font-medium text-ct-paper">{money(HOT_WATER.total)}</span>: the unit costs{' '}
            <span className="font-medium text-ct-paper">{money(HOT_WATER.materials)}</span> and his labour is{' '}
            <span className="font-medium text-ct-paper">{money(HOT_WATER.labour)}</span>. He enters those as two
          ...
          <ol className="space-y-4 mb-6">
            ...
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-ct-surface-2 text-ct-mute-2 text-xs font-semibold flex items-center justify-center">2</span>
              <p className="text-sm text-ct-mute-2 leading-relaxed">
                <span className="font-medium text-ct-paper">Dave does the job. Sarah confirms it's done.</span>
              </p>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-ct-surface-2 text-ct-mute-2 text-xs font-semibold flex items-center justify-center">3</span>
              <p className="text-sm text-ct-mute-2 leading-relaxed">
                <span className="font-medium text-ct-paper">The money is released, and it splits like this:</span>
              </p>
            </li>
          </ol>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <tbody className="divide-y divide-ct-line">
                <tr>
                  <td className="py-2.5 text-ct-mute-2">Job total</td>
                  <td className="py-2.5 text-right tabular-nums text-ct-paper">{money(HOT_WATER.total)}</td>
                </tr>
                <tr>
                  <td className="py-2.5 text-ct-mute-2">
                    Our fee — 8% of Dave's <span className="font-medium">labour</span> only (inc GST)
                  </td>
                  <td className="py-2.5 text-right tabular-nums text-ct-paper">−{money(HOT_WATER.fee)}</td>
                </tr>
                <tr>
          ...
          <div className="mt-5 flex items-start gap-2 rounded-ct-sm bg-ct-teal/[0.14] border border-ct-teal/30 px-4 py-3">
            <Check className="w-4 h-4 text-ct-teal flex-shrink-0 mt-0.5" />
            <p className="text-sm text-ct-teal leading-relaxed">
        ...
        <section className="bg-ct-surface rounded-ct-md shadow-sm p-6">
          <h2 className="text-lg font-semibold text-ct-paper mb-1">Why each line is what it is</h2>
          <div className="divide-y divide-ct-line">
            ...
            <Faq q="Why does the fee include GST?">
              <p>
                ...
                <span className="font-medium text-ct-paper">7.27%</span>. We give you a tax invoice for every fee
                automatically.
              </p>
            </Faq>
            <Faq q="Is there a maximum?">
              <p>
                Yes — the fee is capped at <span className="font-medium text-ct-paper">$500 per job</span> ($400
        ...
        <section className="bg-ct-surface rounded-ct-md shadow-sm p-6">
          <h2 className="text-lg font-semibold text-ct-paper mb-3">The whole model in one sentence</h2>
          <blockquote className="border-l-2 border-ct-teal pl-4 text-sm text-ct-mute-2 leading-relaxed">
          ...
          <Link
            to="/pricing"
            className="mt-6 inline-flex items-center gap-2 bg-ct-teal hover:brightness-110 text-ct-ink px-4 py-2 rounded-ct-sm text-sm font-medium transition-colors"
          >
