...
export default function WelcomeGuide({ role, userName, forceShow }: WelcomeGuideProps) {
  ...
  if (!showTour) {
    return (
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
        <div className="absolute inset-0 bg-ct-surface/40 " />
        ...
        <div className="relative bg-ct-surface rounded-ct-lg shadow-2xl w-full max-w-sm overflow-hidden">
          ...
          <div className="px-6 pt-8 pb-6 text-center">
            <div className="w-14 h-14 bg-ct-amber/[0.13] rounded-ct-lg flex items-center justify-center mx-auto mb-4">
            ...
            <div className="mt-6 space-y-2.5">
              <button
                ...
                className="w-full py-2.5 px-4 bg-ct-teal text-ct-ink text-sm font-semibold rounded-ct-md hover:brightness-110 transition-colors shadow-sm shadow-warm-500/20"
              >
                Show me around
              </button>
              <button
  ...
  return (
    <>
      ...
      <div
        ref={tooltipRef}
        className="z-[70] bg-ct-surface rounded-ct-lg shadow-2xl border border-ct-line-soft w-[min(340px,calc(100vw-24px))] overflow-hidden"
        ...
        <div className="px-5 py-3.5 flex items-center justify-between border-t border-ct-line-soft mt-1">
          ...
          <div className="flex items-center gap-2">
            ...
            {isLast ? (
              <button
                onClick={dismiss}
                className="px-5 py-2 bg-ct-teal text-ct-ink text-sm font-semibold rounded-ct-md hover:brightness-110 transition-colors shadow-sm shadow-warm-500/20"
              >
                Got it!
              </button>
            ) : (
