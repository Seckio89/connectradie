      ...
      {category && (hasSubcategories ? serviceSubtype : customSubtype.trim()) && description.trim() && (
        <div className="space-y-2">
          <button
            ...
            className="w-full py-3.5 font-semibold rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2 text-lg bg-secondary-400 text-white hover:bg-secondary-500 shadow-lg shadow-secondary-100"
          >
            {saving ? (
              <>
