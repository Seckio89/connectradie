      ...
      <div className={`relative group ${className}`}>
        ...
        >
          <div className="flex flex-col items-center gap-3 px-6 py-4">
            ...
            <div className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-ct-teal0 to-ct-teal text-ct-ink text-sm font-bold rounded-ct-md shadow-sm group-hover/gate:shadow-md transition-all min-h-[44px]">
...
export function UpgradeBanner({ message, remainingCount, totalCount, onUpgrade }: UpgradeBannerProps) {
  return (
    <div className="bg-gradient-to-r from-ct-teal to-ct-teal border border-ct-amber/[0.34] rounded-ct-md p-4 flex items-center justify-between gap-4">
      ...
      <button
        onClick={onUpgrade}
        className="flex-shrink-0 flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-ct-teal0 to-ct-teal text-ct-ink text-sm font-semibold rounded-ct-sm shadow-sm hover:shadow-md transition-all"
      >
