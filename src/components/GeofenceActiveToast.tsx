...
export default function GeofenceActiveToast() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-24 sm:bottom-6 sm:left-auto sm:right-6 sm:max-w-sm z-[60] animate-in slide-in-from-bottom-2">
      <div className="flex items-start gap-3 rounded-ct-md bg-ct-surface border border-ct-line shadow-lg p-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-ct-paper">📍 Location tracking active for this job</p>
