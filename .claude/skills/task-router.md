...
Context: React 18 + TypeScript + Tailwind + Supabase + Stripe. Two-sided marketplace for Australian homeowners and tradespeople. 73 Edge Functions. Escrow payments via Stripe Connect.
